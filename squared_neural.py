...
df=pd.read_csv('C:/Users/Josko/Desktop/my_projects/Mach_L/NN/neural_network/en_en/squared_3.csv')
df=df.sample(frac=1)

cdic={'red':0,'blue':1,'green':2}
...
model=keras.Sequential([
    ...
    keras.layers.Dense(24, activation='relu'),
    keras.layers.Dense(3, activation='softmax') # softmax 1, sigmoid 234
    ])
