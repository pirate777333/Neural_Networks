...
df=pd.read_csv('C:/Users/Josko/Desktop/my_projects/Mach_L/NN/neural_network/en_en/color_marker_6b.csv')
df=df.sample(frac=1)
...
##    keras.layers.Dense(32, activation='relu'),
##    keras.layers.Dense(32, activation='relu'),
    keras.layers.Dense(9, activation='sigmoid') # softmax 1, sigmoid 234
    ])
...
model.fit(x,trlab,batch_size=16,epochs=10)
