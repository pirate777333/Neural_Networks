...
df=pd.read_csv('C:/Users/Josko/Desktop/my_projects/Mach_L/NN/neural_network/en_en/linear_2.csv')
df=df.sample(frac=1)
...
model=keras.Sequential([
    ...
    keras.layers.Dense(2, activation='softmax') # softmax 1, sigmoid 234
    ])
...
model.fit(x,train.color.values,batch_size=8,epochs=2)
